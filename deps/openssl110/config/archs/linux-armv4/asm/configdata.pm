...
our %config = (
  ...
  defines => [ "DSO_DLFCN", "HAVE_DLFCN_H", "NDEBUG", "OPENSSL_NO_DYNAMIC_ENGINE", "OPENSSL_PIC", "OPENSSL_BN_ASM_MONT", "OPENSSL_BN_ASM_GF2m", "SHA1_ASM", "SHA256_ASM", "SHA512_ASM", "AES_ASM", "BSAES_ASM", "GHASH_ASM", "ECP_NISTZ256_ASM", "POLY1305_ASM" ],
  ...
  perl => "/usr/bin/perl",
  perlargv => [ "no-shared", "no-threads", "no-afalgeng", "linux-armv4" ],
  prefix => "",
  processor => "",
