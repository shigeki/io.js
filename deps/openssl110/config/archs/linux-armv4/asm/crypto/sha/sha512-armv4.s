...
.L00_15:
 ...
 @ 4 lo>>14^hi<<18 ^ lo>>18^hi<<14 ^ hi>>9^lo<<23
 @ 0 hi>>14^lo<<18 ^ hi>>18^lo<<14 ^ lo>>9^hi<<23
 mov r9,r7,lsr#14
 str r3,[sp,#64+0]
 mov r10,r8,lsr#14
 str r4,[sp,#64+4]
 ...
 @ 4 lo>>28^hi<<4 ^ hi>>2^lo<<30 ^ hi>>7^lo<<25
 @ 0 hi>>28^lo<<4 ^ lo>>2^hi<<30 ^ lo>>7^hi<<25
 mov r9,r5,lsr#28
 mov r10,r6,lsr#28
 eor r9,r9,r6,lsl#4
...
.L16_79:
 ...
 @ 4 lo>>1^hi<<31 ^ lo>>8^hi<<24 ^ lo>>7^hi<<25
 @ 0 hi>>1^lo<<31 ^ hi>>8^lo<<24 ^ hi>>7
 mov r3,r9,lsr#1
 ldr r11,[sp,#80+0]
 mov r4,r10,lsr#1
 ldr r12,[sp,#80+4]
 ...
 @ 4 lo>>19^hi<<13 ^ hi>>29^lo<<3 ^ lo>>6^hi<<26
 @ 0 hi>>19^lo<<13 ^ lo>>29^hi<<3 ^ hi>>6
 mov r9,r11,lsr#19
 mov r10,r12,lsr#19
