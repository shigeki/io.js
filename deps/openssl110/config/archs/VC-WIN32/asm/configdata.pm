...
our %config = (
  ...
  defines => [ "DSO_WIN32", "NDEBUG", "OPENSSL_NO_DYNAMIC_ENGINE", "OPENSSL_PIC", "OPENSSL_BN_ASM_PART_WORDS", "OPENSSL_IA32_SSE2", "OPENSSL_BN_ASM_MONT", "OPENSSL_BN_ASM_GF2m", "SHA1_ASM", "SHA256_ASM", "SHA512_ASM", "RC4_ASM", "MD5_ASM", "RMD160_ASM", "AES_ASM", "VPAES_ASM", "WHIRLPOOL_ASM", "GHASH_ASM", "ECP_NISTZ256_ASM", "PADLOCK_ASM", "POLY1305_ASM" ],
  ...
  perl => "/usr/bin/perl",
  perlargv => [ "no-shared", "no-comp", "no-ssl3", "no-afalgeng", "no-threads", "VC-WIN32" ],
  prefix => "",
  processor => "",
