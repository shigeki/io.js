{
  'variables': {
    'openssl_sources': [
      ...
      'openssl/crypto/aes/vpaes-armv8.s',
      ...
      'openssl/crypto/bn/armv8-mont.s',
      ...
      'openssl/crypto/chacha/chacha-armv8.s',
      ...
      'openssl/crypto/ec/ecp_nistz256-armv8.s',
      ...
      'openssl/crypto/poly1305/poly1305-armv8.s',
      ...
      'openssl/crypto/sha/sha1-armv8.s',
      'openssl/crypto/sha/sha1_one.c',
      'openssl/crypto/sha/sha1dgst.c',
      'openssl/crypto/sha/sha256-armv8.s',
      'openssl/crypto/sha/sha256.c',
      'openssl/crypto/sha/sha512-armv8.s',
