...
.type	_ecp_nistz256_to_mont,@function
.align	4
...
L000pic:
	...
	leal	__GLOBAL_OFFSET_TABLE_+[.-L000pic](%eax),%eax
...
.type	_ecp_nistz256_from_mont,@function
.align	4
...
L001pic:
	...
	leal	__GLOBAL_OFFSET_TABLE_+[.-L001pic](%eax),%eax
	movl	_OPENSSL_ia32cap_P@GOT(%eax),%eax
	movl	(%eax),%eax
	movl	20(%esp),%edi
	call	__ecp_nistz256_mul_mont
...
L_ecp_nistz256_mul_mont_begin:
	...
	call	__picup_eax
L002pic:
	leal	__GLOBAL_OFFSET_TABLE_+[.-L002pic](%eax),%eax
	movl	_OPENSSL_ia32cap_P@GOT(%eax),%eax
	movl	(%eax),%eax
	movl	20(%esp),%edi
	call	__ecp_nistz256_mul_mont
...
.type	_ecp_nistz256_sqr_mont,@function
.align	4
...
L_ecp_nistz256_sqr_mont_begin:
	...
	call	__picup_eax
L003pic:
	leal	__GLOBAL_OFFSET_TABLE_+[.-L003pic](%eax),%eax
	movl	_OPENSSL_ia32cap_P@GOT(%eax),%eax
	movl	(%eax),%eax
	movl	20(%esp),%edi
	movl	%esi,%ebp
...
.type	_ecp_nistz256_scatter_w5,@function
.align	4
...
.type	_ecp_nistz256_gather_w5,@function
.align	4
...
.type	_ecp_nistz256_scatter_w7,@function
.align	4
...
.type	_ecp_nistz256_gather_w7,@function
.align	4
...
.type	_ecp_nistz256_point_double,@function
.align	4
...
L_ecp_nistz256_point_double_begin:
	...
	call	__picup_eax
L008pic:
	leal	__GLOBAL_OFFSET_TABLE_+[.-L008pic](%eax),%edx
...
.type	_ecp_nistz256_point_add,@function
.align	4
...
L_ecp_nistz256_point_add_begin:
	...
	call	__picup_eax
L009pic:
	leal	__GLOBAL_OFFSET_TABLE_+[.-L009pic](%eax),%edx
	movl	_OPENSSL_ia32cap_P@GOT(%edx),%edx
	movl	(%edx),%ebp
	leal	192(%esp),%edi
	movl	(%esi),%eax
...
.type	_ecp_nistz256_point_add_affine,@function
.align	4
...
L_ecp_nistz256_point_add_affine_begin:
	...
	call	__picup_eax
L013pic:
	leal	__GLOBAL_OFFSET_TABLE_+[.-L013pic](%eax),%edx
	movl	_OPENSSL_ia32cap_P@GOT(%edx),%edx
	movl	(%edx),%ebp
	leal	96(%esp),%edi
	movl	(%esi),%eax
