...
our %config = (
  ...
  defines => [ "DSO_DLFCN", "HAVE_DLFCN_H", "NDEBUG", "OPENSSL_NO_DYNAMIC_ENGINE", "OPENSSL_PIC", "OPENSSL_BN_ASM_MONT", "OPENSSL_BN_ASM_GF2m", "SHA1_ASM", "SHA256_ASM", "SHA512_ASM", "RC4_ASM", "AES_ASM", "AES_CTR_ASM", "AES_XTS_ASM", "GHASH_ASM", "POLY1305_ASM" ],
  ...
  perl => "/usr/bin/perl",
  perlargv => [ "no-shared", "no-threads", "no-afalgeng", "linux32-s390x" ],
  prefix => "",
  processor => "",
...
our %target = (
  ...
  cast_obj => "c_enc.o",
  cc => "gcc",
  cflags => "-Wall -O3 -m31 -Wa,-mzarch -DB_ENDIAN",
