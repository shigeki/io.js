...
$L015grand_avx:
	...
	vpaddd	xmm4,xmm0,QWORD PTR [ebp]
	vpshufb	xmm3,xmm3,xmm7
	vpaddd	xmm5,xmm1,QWORD PTR 16[ebp]
	vpaddd	xmm6,xmm2,QWORD PTR 32[ebp]
	vpaddd	xmm7,xmm3,QWORD PTR 48[ebp]
...
$L016avx_00_47:
	...
	shrd	edx,edx,14
	mov	esi,DWORD PTR 8[esp]
	vpaddd	xmm6,xmm0,QWORD PTR [ebp]
	xor	edx,ecx
	mov	edi,DWORD PTR 12[esp]
	xor	esi,edi
	shrd	edx,edx,5
	...
	shrd	edx,edx,14
	mov	esi,DWORD PTR 24[esp]
	vpaddd	xmm6,xmm1,QWORD PTR 16[ebp]
	xor	edx,ecx
	mov	edi,DWORD PTR 28[esp]
	xor	esi,edi
	shrd	edx,edx,5
	...
	shrd	edx,edx,14
	mov	esi,DWORD PTR 24[esp]
	vpaddd	xmm6,xmm3,QWORD PTR 48[ebp]
	xor	edx,ecx
	mov	edi,DWORD PTR 28[esp]
	xor	esi,edi
	shrd	edx,edx,5
