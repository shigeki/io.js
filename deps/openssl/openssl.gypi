{
  'variables': {
    ...
    'openssl_sources_ia32_win32_masm': [
...
### End of ASM defines
    ...
    'openssl_defines_x64_linux': [
      '<@(openssl_defines_asm_x64)',
      '<@(openssl_defines_defaults_unix)',
      'OPENSSLDIR="/etc/ssl"',
      'TERMIOS',
    ],
    'openssl_defines_solaris': [
      '__EXTENSIONS__',
    ],
