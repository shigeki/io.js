{
  'variables': {
    ...
    'openssl_sources_asm_latest_x64_elf_gas': [
      ...
      'asm/sha512/x64-elf-gas/sha/sha512-x86_64.s',
    ...
    'openssl_sources_asm_obsolete_x64_elf_gas': [
      ...
      'asm_obsolete/sha512/x64-elf-gas/sha/sha512-x86_64.s',
    ...
    'openssl_sources_asm_latest_x64_mac_gas': [
      ...
      'asm/sha512/x64-macosx-gas/sha/sha512-x86_64.s',
    ...
    'openssl_sources_asm_obsolete_x64_mac_gas': [
      ...
      'asm_obsolete/sha512/x64-macosx-gas/sha/sha512-x86_64.s',
    ...
    'openssl_sources_arm64_linux64_gas': [
      ...
      'asm/sha512/arm64-linux64-gas/sha/sha512-armv8.S',
      # No asm available
      'openssl/crypto/aes/aes_core.c',
      'openssl/crypto/aes/aes_cbc.c',
      'openssl/crypto/bn/bn_asm.c',
    ...
    'openssl_sources_asm_latest_x64_win_masm': [
      ...
      'asm/sha512/x64-win32-masm/sha/sha512-x86_64.asm',
    ...
    'openssl_sources_asm_obsolete_x64_win_masm': [
      ...
      'asm_obsolete/sha512/x64-win32-masm/sha/sha512-x86_64.asm',
    ...
    #
    # Asm files are changed depending on the version of asm compiler.
    # We provide two sets of asm files, one is asm_latest(avx2 and
    # addx supported) and the other asm_obsolute(without avx1/2 and addx)
