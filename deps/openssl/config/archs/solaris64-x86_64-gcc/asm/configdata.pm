...
our %config = (
  ...
  perl => "/usr/bin/perl",
  perlargv => [ "no-shared", "no-comp", "no-ssl3", "solaris64-x86_64-gcc" ],
  perlenv => {
      "AR" => undef,
      "ARFLAGS" => undef,
      "AS" => undef,
...
our %target = (
  ...
  dso_cxxflags => "",
  dso_extension => ".so",
  dso_lflags => "-shared -static-libgcc -Wl,-Bsymbolic",
  dso_scheme => "DLFCN",
