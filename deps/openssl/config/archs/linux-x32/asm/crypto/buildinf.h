...
#define DATE "built on: Tue Feb 20 09:50:39 2018 UTC"
...
static const char compiler_flags[] = {
    ...
    ' ','-','m','x','3','2',' ','-','D','D','S','O','_','D','L','F',
    'C','N',' ','-','D','H','A','V','E','_','D','L','F','C','N','_',
    'H',' ','-','D','N','D','E','B','U','G',' ','-','D','O','P','E',
    'N','S','S','L','_','N','O','_','D','Y','N','A','M','I','C','_',
    'E','N','G','I','N','E',' ','-','D','O','P','E','N','S','S','L',
