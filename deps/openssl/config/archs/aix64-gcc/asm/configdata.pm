...
our %config = (
  ...
  builddir => ".",
  cc => "gcc",
  cflags => [ "-maix64 -O -pthread" ],
  conf_files => [ "Configurations/00-base-templates.conf", "Configurations/10-main.conf", "Configurations/shared-info.pl" ],
  cppflags => [ "-DB_ENDIAN" ],
  cross_compile_prefix => "",
  cxxflags => [  ],
  defines => [ "DSO_DLFCN", "HAVE_DLFCN_H", "NDEBUG", "OPENSSL_NO_DYNAMIC_ENGINE", "OPENSSL_PIC", "OPENSSL_CPUID_OBJ", "OPENSSL_BN_ASM_MONT", "SHA1_ASM", "SHA256_ASM", "SHA512_ASM", "AES_ASM", "VPAES_ASM", "ECP_NISTZ256_ASM", "POLY1305_ASM" ],
  ...
  perl => "/usr/bin/perl",
  perlargv => [ "no-shared", "no-comp", "no-ssl3", "no-afalgeng", "aix64-gcc" ],
  perlenv => {
      "AR" => undef,
      "ARFLAGS" => undef,
      "AS" => undef,
  ...
  sdirs => [ "objects", "md4", "md5", "sha", "mdc2", "hmac", "ripemd", "whrlpool", "poly1305", "blake2", "siphash", "sm3", "des", "aes", "rc2", "rc4", "idea", "aria", "bf", "cast", "camellia", "seed", "sm4", "chacha", "modes", "bn", "ec", "rsa", "dsa", "dh", "dso", "engine", "buffer", "bio", "stack", "lhash", "rand", "err", "evp", "asn1", "pem", "x509", "x509v3", "conf", "txt_db", "pkcs7", "pkcs12", "ocsp", "ui", "cms", "ts", "srp", "cmac", "ct", "async", "kdf", "store" ],
  shlib_major => "1",
  shlib_minor => "1",
...
our %target = (
  _conf_fname_int => [ "Configurations/00-base-templates.conf", "Configurations/00-base-templates.conf", "Configurations/00-base-templates.conf", "Configurations/00-base-templates.conf", "Configurations/10-main.conf", "Configurations/shared-info.pl" ],
  ...
  dso_cxxflags => "",
  dso_extension => ".so",
  dso_lflags => "-shared -static-libgcc -Wl,-G -Wl,-bexpall,-bnolibpath,-bM:SRE",
  dso_scheme => "DLFCN",
  ec_asm_src => "ecp_nistz256.c ecp_nistz256-ppc64.s",
  ec_obj => "ecp_nistz256.o ecp_nistz256-ppc64.o",
  enable => [  ],
  ex_libs => "-pthread",
  exe_extension => "",
  hashbangperl => "/usr/bin/env perl",
  ...
  shared_ldflag => "-shared -static-libgcc -Wl,-G -Wl,-bexpall,-bnolibpath,-bM:SRE",
  shared_rcflag => "",
