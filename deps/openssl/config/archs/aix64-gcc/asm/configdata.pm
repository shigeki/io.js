...
our %config = (
  ...
  includes => [  ],
  lflags => [  ],
  lib_defines => [ "DSO_DLFCN", "HAVE_DLFCN_H", "OPENSSL_PIC", "OPENSSL_CPUID_OBJ", "OPENSSL_BN_ASM_MONT", "SHA1_ASM", "SHA256_ASM", "SHA512_ASM", "AES_ASM", "VPAES_ASM", "ECP_NISTZ256_ASM", "POLY1305_ASM" ],
  libdir => "",
  major => "1",
...
our %target = (
  ...
  module_cflags => "",
  module_cxxflags => "",
  module_ldflags => "-shared -static-libgcc -Wl,-G -Wl,-bexpall,-bnolibpath,-bM:SRE",
  padlock_asm_src => "",
  padlock_obj => "",
