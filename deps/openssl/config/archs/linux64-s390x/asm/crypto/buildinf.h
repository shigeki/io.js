...
#define DATE "built on: Tue Feb 20 10:03:00 2018 UTC"
...
static const char compiler_flags[] = {
    ...
    'S','M',' ','-','D','A','E','S','_','A','S','M',' ','-','D','A',
    'E','S','_','C','T','R','_','A','S','M',' ','-','D','A','E','S',
    '_','X','T','S','_','A','S','M',' ','-','D','G','H','A','S','H',
    '_','A','S','M',' ','-','D','P','O','L','Y','1','3','0','5','_',
    'A','S','M',' ','-','D','O','P','E','N','S','S','L','_','U','S',
    'E','_','N','O','D','E','L','E','T','E',' ','-','D','B','_','E',
    'N','D','I','A','N','\0'
};
