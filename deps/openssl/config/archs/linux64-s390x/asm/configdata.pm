...
our %config = (
  ...
  includes => [  ],
  lflags => [  ],
  lib_defines => [ "DSO_DLFCN", "HAVE_DLFCN_H", "OPENSSL_PIC", "OPENSSL_CPUID_OBJ", "OPENSSL_BN_ASM_MONT", "OPENSSL_BN_ASM_GF2m", "SHA1_ASM", "SHA256_ASM", "SHA512_ASM", "RC4_ASM", "AES_ASM", "AES_CTR_ASM", "AES_XTS_ASM", "GHASH_ASM", "POLY1305_ASM" ],
  libdir => "",
  major => "1",
