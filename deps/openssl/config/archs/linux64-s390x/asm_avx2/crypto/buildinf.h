...
#define DATE "built on: Thu Nov  8 05:39:56 2018 UTC"
...
static const char compiler_flags[] = {
    'c','o','m','p','i','l','e','r',':',' ','.','/','f','a','k','e',
    '_','g','c','c','.','p','l',' ','-','f','P','I','C',' ','-','p',
    't','h','r','e','a','d',' ','-','m','6','4',' ','-','W','a','l',
    'l',' ','-','O','3',' ','-','D','O','P','E','N','S','S','L','_',
    'U','S','E','_','N','O','D','E','L','E','T','E',' ','-','D','B',
    ...
    '4','_','A','S','M',' ','-','D','A','E','S','_','A','S','M',' ',
    '-','D','A','E','S','_','C','T','R','_','A','S','M',' ','-','D',
    'A','E','S','_','X','T','S','_','A','S','M',' ','-','D','G','H',
    'A','S','H','_','A','S','M',' ','-','D','P','O','L','Y','1','3',
