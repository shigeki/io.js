...
#define DATE "built on: Sat Feb 24 14:59:08 2018 UTC"
...
static const char compiler_flags[] = {
    ...
    'a','l','l',' ','-','O','3',' ','-','f','o','m','i','t','-','f',
    'r','a','m','e','-','p','o','i','n','t','e','r',' ','-','p','t',
    'h','r','e','a','d',' ','-','D','D','S','O','_','D','L','F','C',
    ...
    'L','_','B','N','_','A','S','M','_','P','A','R','T','_','W','O',
    'R','D','S',' ','-','D','O','P','E','N','S','S','L','_','I','A',
    ...
    'S','M',' ','-','D','M','D','5','_','A','S','M',' ','-','D','R',
    'M','D','1','6','0','_','A','S','M',' ','-','D','A','E','S','_',
    ...
    'O','L','Y','1','3','0','5','_','A','S','M',' ','-','D','F','I',
    'L','I','O','_','H',' ','-','D','L','_','E','N','D','I','A','N','\0'
};
