...
#define DATE "built on: Sat May  5 14:26:14 2018 UTC"
...
static const char compiler_flags[] = {
    ...
    'R','C','4','_','A','S','M',' ','-','D','A','E','S','_','A','S',
    'M',' ','-','D','A','E','S','_','C','T','R','_','A','S','M',' ',
    '-','D','A','E','S','_','X','T','S','_','A','S','M',' ','-','D',
    'G','H','A','S','H','_','A','S','M',' ','-','D','P','O','L','Y',
