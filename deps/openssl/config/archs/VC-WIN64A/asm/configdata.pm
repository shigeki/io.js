...
our %config = (
  ...
  perl => "/usr/bin/perl",
  perlargv => [ "no-shared", "no-comp", "no-ssl3", "VC-WIN64A" ],
  perlenv => {
      "AR" => undef,
      "ARFLAGS" => undef,
      "AS" => undef,
