...
#define DATE "built on: Fri Nov  2 04:32:41 2018 UTC"
...
static const char compiler_flags[] = {
    ...
    '_','g','c','c','.','p','l',' ','-','f','P','I','C',' ','-','a',
    'r','c','h',' ','i','3','8','6',' ','-','O','3',' ','-','f','o',
