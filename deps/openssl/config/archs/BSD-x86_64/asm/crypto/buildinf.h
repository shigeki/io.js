...
#define DATE "built on: Tue Feb 20 09:49:37 2018 UTC"
...
static const char compiler_flags[] = {
    'c','o','m','p','i','l','e','r',':',' ','c','c',' ','-','W','a',
    'l','l',' ','-','O','3',' ','-','p','t','h','r','e','a','d',' ',
    '-','D','D','S','O','_','D','L','F','C','N',' ','-','D','H','A',
    'V','E','_','D','L','F','C','N','_','H',' ','-','D','N','D','E',
    'B','U','G',' ','-','D','O','P','E','N','S','S','L','_','N','O',
