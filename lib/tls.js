...
if (process._tls_defaults) {
  try {
    var TLS_DEFAULTS = JSON.parse(process._tls_defaults);
  } catch (err) {
    err.message = '--overwrite-tls-default JSON.parse error: ' + err.message;
    throw err;
  }
  var DEFAULT_CIPHERS = TLS_DEFAULTS.DEFAULT_CIPHERS;
  var DEFAULT_ECDH_CURVE = TLS_DEFAULTS.DEFAULT_ECDH_CURVE;
}
...
exports.DEFAULT_ECDH_CURVE = DEFAULT_ECDH_CURVE || 'prime256v1';
