...
const uint8_t* cnnic_ev_p = CNNIC_EV_ROOT_CA_SUBJECT_DATA;
...
inline int IsWhitelistedServerCertificate(X509_STORE_CTX* ctx) {
...
int VerifyCallback(int preverify_ok, X509_STORE_CTX* ctx) {
  ...
  return IsWhitelistedServerCertificate(ctx);
}
